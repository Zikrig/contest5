    ...
    def get_result(self):
           ...
           (self.squars[2].i == self.squars[2].i and self.squars[0].i+self.squars[0].li == self.squars[1].i+self.squars[1].li)):
            self.paint_squars(
                Square(
                    ...
                    self.squars[0].li,
                    self.squars[0].j,
                    self.squars[0].lj+self.squars[1].j
                    ),
                Square(
                    self.squars[2].li+self.squars[2].i,
                    self.squars[1].li,
                    self.squars[1].j,
                    self.squars[1].lj
                    )
        ...
        if(self.squars[0].i == self.squars[2].i and self.squars[0].li == self.squars[2].li):
            if(self.squars[0].i == self.squars[1].i):
                ...
                Square(
                    self.squars[1].i+self.squars[0].li,
                    self.squars[1].li,
                    self.squars[1].j-self.squars[0].li,
                    self.squars[1].lj
                    )
                )
                return True
            
            # if(self.squars[0].i+self.squars[0].li == self.squard[1].i+self.squard[1].li):
            #     self.paint_squars(
            #     Square(
            #         self.squars[0].i,
            #         self.squars[0].li,
